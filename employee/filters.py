...
class EmployeeFilter(HorillaFilterSet):
    ...
    department_name = django_filters.CharFilter(
       field_name="employee_work_info__department_id__department", lookup_expr="icontains"
    )
    job_position_title = django_filters.CharFilter(
       field_name="employee_work_info__job_position_id__job_position", lookup_expr="icontains"
    )
    job_position_name = django_filters.CharFilter(
       field_name="employee_work_info__job_position_id__job_position", lookup_expr="icontains"
    )
    job_role_id = django_filters.NumberFilter(field_name="employee_work_info__job_role_id", lookup_expr="exact")
